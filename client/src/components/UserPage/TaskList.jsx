            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="px-1 py-2 lg:text-start text-start text-xs font-bold text-black-500 uppercase dark:text-neutral-500">Tasks</th>
                  <th scope="col" className="hidden sm:table-cell px-1 py-2 text-start text-xs font-bold text-black-500 uppercase dark:text-neutral-500 lg:flex">
                    Priority
                    {!viewPriority && (
                      <FontAwesomeIcon
                  ...
                  <th scope="col" className="px-1 py-2 text-start text-xs font-bold text-black-500 uppercase dark:text-neutral-500 flex">
                    Due Date
                    {!viewDate && (
                      <FontAwesomeIcon
                        className="ml-1 text-lg cursor-pointer"
